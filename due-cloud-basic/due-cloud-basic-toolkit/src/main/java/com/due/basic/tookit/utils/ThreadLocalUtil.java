...
public class ThreadLocalUtil {
    ...
    public static void setDueRequest(DueRequest dueRequest) {
        ...
        Optional.ofNullable(dueRequest.getModuleRequestCode()).ifPresent(e -> ThreadContextStoreUtil.getInstance().set(GlobalThreadLocalConstant.MODULE_REQUEST_CODE, e));
    ...
    public static void removeDueRequest() {
        ...
        ThreadContextStoreUtil.getInstance().removeKey(GlobalThreadLocalConstant.MODULE_REQUEST_CODE);
    ...
    public static DueRequest getDueRequest() {
       return   DueRequest.of().setSerialNo(ThreadLocalUtil.getSerialNo()).setChannelEnum(ThreadLocalUtil.getChannel())
                ...
                .setModuleRequestCode( (ModuleCodeEnum)ThreadContextStoreUtil.getInstance().get(GlobalThreadLocalConstant.MODULE_REQUEST_CODE))
