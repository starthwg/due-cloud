...
public class MobileOpenIdAuthenticationProvider extends DueAuthenticationProvider {
    ...
    protected Authentication createSuccessAuthentication(UserDetails userDetails, Authentication authentication) {
        ...
        WeChatAuthenticationAuth auth = new WeChatAuthenticationAuth(basicUser.getMemberId(),  authenticationAuth.getGrantType(),  authenticationAuth.getTokenRequest(),  true, basicUser.getAuthorities(),  basicUser.getOpenId());
        return auth;
    }
